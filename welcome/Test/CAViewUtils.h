...
//some Animation Type
#define CAView_Anima_PageCurl @"pageCurl"//向上翻页
#define CAView_Anima_PageUnCurl @"pageUnCurl"//向下翻页
#define CAView_Anima_CameraIrisHollowOpen @"cameraIrisHollowOpen" //相机打开
#define CAView_Anima_RippleEffect @"rippleEffect" //滴水效果
#define CAView_Anima_OglFlip @"oglFlip" //上下翻转
#define CAView_Anima_Cube @"cube" //立方体效果
#define CAView_Anima_SuckEffect @"suckEffect" //收缩效果
#define CAView_Anima_CameraIrisHollowClose @"cameraIrisHollowClose" //相机关闭
#define CAView_Anima_Fade kCATransitionFade //淡入淡出
#define CAView_Anima_MoveIn kCATransitionMoveIn //移进
#define CAView_Anima_Reveal kCATransitionReveal //揭开
// some sub type
#define CAView_AnimaSubType_FromTop kCATransitionFromTop //从上方进入
#define CAView_AnimaSubType_FromBottom kCATransitionFromBottom //从下方进入
#define CAView_AnimaSubType_FromLeft kCATransitionFromLeft  //从左边进入
#define CAView_AnimaSubType_FromRight kCATransitionFromRight //从右边进入

@interface CAViewUtils : NSObject
...
+(CATransition*)AnimationLayer:(NSString*)type; //type 在上面  CAView_Anima_PageCurl
